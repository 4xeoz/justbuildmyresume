-- CreateEnum
CREATE TYPE "ExperienceType" AS ENUM ('JOB', 'PROJECT', 'VOLUNTEER', 'EDUCATION');
...
-- CreateIndex
CREATE INDEX "highlights_experienceId_idx" ON "highlights"("experienceId");
...
-- AddForeignKey
ALTER TABLE "highlights" ADD CONSTRAINT "highlights_experienceId_fkey" FOREIGN KEY ("experienceId") REFERENCES "experiences"("id") ON DELETE CASCADE ON UPDATE CASCADE;
